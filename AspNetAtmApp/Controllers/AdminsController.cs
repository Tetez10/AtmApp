...
namespace AspNetAtmApp.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public AdminsController(AspNetAtmAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Admin != null ? 
                          ...
                          Problem("Entity set 'AspNetAtmAppContext.Admin'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AspNetAtmAppContext.Admin'  is null.");
            }
            var admin = await _context.Admin.FindAsync(id);
            if (admin != null)
            {
